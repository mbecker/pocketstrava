...
var defaultVerificationTemplate = core.EmailTemplate{
...
var defaultResetPasswordTemplate = core.EmailTemplate{
...
var defaultConfirmEmailChangeTemplate = core.EmailTemplate{
...
var DefaultNotificationVerificationTemplate = core.EmailTemplate{
	Subject: "Confirm your " + EmailPlaceholderAppName + " email address",
	Body: `<p>Hello,</p>
...
<p>
  ...
  ` + EmailPlaceholderAppName + ` team
	...
	ActionUrl: os.Getenv("NOTIFICATION_VERIFICATION_URL"),
}
